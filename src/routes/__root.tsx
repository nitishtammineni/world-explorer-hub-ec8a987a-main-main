...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Bespoke tours, parties and travel experiences across every country in the world.",
      },
      { name: "author", content: "Vicky Ryoko Tours and Party's" },
      ...
      { name: "twitter:site", content: "@VickyRyokoTours" },
    ],
    links: [
      {
        rel: "stylesheet",
